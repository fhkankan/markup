...
python3  "${PROJPATH}/test.py"  --env=${SOURCEENV} >> "${PROJPATH}/logs/service.${SOURCEENV}.test-${DTSTAMP}.log"  2>&1 &
```
...
if __name__ == '__main__':
    ...
    init_logger(f"./logs/console.{env}.test-{cur_day}.log", level="INFO", count=30)
