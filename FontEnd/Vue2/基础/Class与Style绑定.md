...
这样写将始终添加 `errorClass`，但是只有在 `isActive` 是 truthy[[1\]](https://github.com/vuejs/cn.vuejs.org/blob/master/src/v2/guide/class-and-style.md#footnote-1) 时才添加 `activeClass`。
...
> 这个章节假设你已经对 [Vue 组件](https://github.com/vuejs/cn.vuejs.org/blob/master/src/v2/guide/components.html)有一定的了解。当然你也可以先跳过这里，稍后再回过头来看。
